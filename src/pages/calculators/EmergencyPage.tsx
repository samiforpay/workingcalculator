...
export default function EmergencyPage() {
  // Filter misc calculators to only show emergency related ones
  const emergencyTools = miscCalculators.filter(calc => 
    calc.href.includes('emergency')
  )
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-grow container mx-auto px-4 py-12">
        <h1 className="text-4xl font-bold mb-8 text-center text-blue-900">Emergency Fund</h1>
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          {emergencyTools.map((calculator: CalculatorConfig) => (
