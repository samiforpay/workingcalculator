import { roiCalculators } from '@/config/calculators'
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-grow container mx-auto px-4 py-12">
        <h1 className="text-4xl font-bold mb-8 text-center text-blue-900">ROI Calculators</h1>
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          {roiCalculators.map((calculator: CalculatorConfig) => (
